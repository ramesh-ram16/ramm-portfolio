  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 w-full grid md:grid-cols-2 gap-12 items-center py-32">
        ...
        {/* Left Content */}
        <div>
<h1 className="text-6xl md:text-8xl font-extrabold leading-tight bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent">
  Frontend Developer
  <br />
  <span className="text-white text-4xl md:text-5xl font-semibold">
    Crafting fast, modern web experiences
          ...
          <p className="mt-6 text-gray-400 text-lg">
            Building modern web interfaces with precision and clarity.
          </p>
